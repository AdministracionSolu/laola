-- ============================================================
-- FACTURACIÓN v7 — la sucursal es OBLIGATORIA
-- Antes, si la solicitud llegaba sin ?suc= (el caso normal: la liga
-- pelona https://laola.mx/factura que manda la auto-respuesta de
-- WhatsApp), el código caía a 'GEN': folio FAC-GEN-YYMMDD-###,
-- sucursal_id NULL y la contadora sin saber qué sucursal factura.
-- Ahora el front obliga a marcarla y la RPC la exige y la valida
-- contra el catálogo (nada de códigos inventados).
-- Misma firma que v6 → CREATE OR REPLACE basta (sin DROP ni GRANT).
-- ============================================================
