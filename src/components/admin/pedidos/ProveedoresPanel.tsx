...
import { RefreshCw, Copy, Loader2, Scale, Link2, Download, Package, Check, X, ChevronLeft, ChevronRight, CalendarDays, RotateCcw } from "lucide-react";
...
// Todo el módulo de Proveedores & Precios (Comparativa / Listas / Ligas) como
// panel embebible. Vive dentro de /admin/pedido-dia y en /admin/proveedores;
// quien lo monte ya validó la sesión de admin.
  ...
  return (
    <Tabs defaultValue="comparativa">
      <div className="mb-4 flex items-center justify-between gap-2">
        ...
        <Button variant="ghost" size="icon" onClick={fetchAll} aria-label="Actualizar"><RefreshCw className="h-4 w-4" /></Button>
      </div>
